export default function HowToUsePage() {
    return (
        <div className="footer-page">
            <h2>How to Use</h2>
            <p>
                Start at the table. Type a country name in the search bar to narrow the list, or simply scroll.
                Click any row and you’ll jump to a detail page that shows every legal milestone for that country.
                <br />
                <br />
                ...
                That’s it: search, inspect, save, compare. The rest is up to the questions you ask.
            </p>
        </div>
    );
}